...
var creatureTF = ["centaur", "dragon", "unicorn", "dinosaur", "succubus", "alien", "elf", "sphinx", "hellhound", "cerberus", "harpy", "hydra", "naga", "gryphon", "pegasus", 
				  ...
				  "imp", "demon", "dwarf", "ghost", "ogre", "pixie", "siren", "vampire", "yeti"];
...
var TGfem = ["Her pussy transforms into a dick", "She grows a dick above her pussy", "She transforms into a man", "She transforms into a femboi", "She transforms into a drag queen", "She transforms into a man", "She transforms into a man"];
var TGmale = ["Her dick transforms into a pussy", "She grows a pussy beneath her dick", "She grows boobs", "She transforms into a woman", "She transforms into a bimbo", "She transforms into a amazoness", "She transforms into a pregnant woman", "She transforms into a woman", "She transforms into a woman"];
...
var otherTF = ["mime", "nerd", "robot", "MILF", "amazoness"];
...
var reaction = ["aroused by", "confused about", "scared of", "shocked by", "terrified of", "embarrassed by", "surprised by", "happy with", "annoyed by", "ashamed by", "humiliated by",
...
var trigger = ["accidentally messing up a spell", "pissing off a witch", "their family curse kicking in,", "using a strange morph app", "their allergy kicking in,", "contracting a virus", 
			   ...
			   "an experiment", "drinking a new energy drink", "putting on cheap make-up", "playing a mobile game", "an infection they got from a scratch", "getting a new tattoo", "clicking on a pop-up advertisement", 
			   ...
			   "a doctor who accidentally mixed up his clients/end", "reading a book", "wearing a costume they bought from a pop-up store", "being caught spying on a witch", "an experiment gone wrong",
			   ...
			   "being sucked into a black hole, and then spit back/end", "getting piercings", "using new sex-toys", "a salesman showcasing his products/end", "going into the sewers/end", "using experimental pills",
